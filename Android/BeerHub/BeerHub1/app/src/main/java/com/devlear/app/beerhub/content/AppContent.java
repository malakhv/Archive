...
import com.devlear.app.beerhub.BuildConfig;
import com.devlear.app.beerhub.R;
import com.devlear.app.beerhub.util.FileUtils;
import com.devlear.app.beerhub.util.ResUtils;
import com.devlear.app.beerhub.util.ZipUtils;
...
public class AppContent {
    ...
    private static final String DATA_PATH = "content";

    /** The default path (in app data) for media content (images, icons, etc.). */
    private static final String MEDIA_PATH = DATA_PATH + "/media";

    /** The default path (in app data) for wiki content (html pages and related files). */
    private static final String WIKI_PATH = DATA_PATH + "/wiki";
    ...
    private static File getContentDir(Context context) {
        final File f = new File(context.getFilesDir(), DATA_PATH);
    ...
    public static void removeContent(Context context) {
        File f = new File(context.getFilesDir(), DATA_PATH);
