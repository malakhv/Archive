...
import com.devlear.beerhub.content.FileResources;
...
public final class PoiHelper {
    ...
    public static String getIconPath(PoiType type, long id) {
        // /data/user/0/com.devlear.beerhub/files/content + /media/ + place + / +
        // /data/user/0/com.devlear.beerhub/files/content/media/place/3/icon_128.png
