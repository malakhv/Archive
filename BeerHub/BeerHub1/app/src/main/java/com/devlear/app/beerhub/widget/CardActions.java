...
public class CardActions extends LinearLayout {
    ...
    public static final int ACTION_MORE = 64;
    ...
    public CardActions(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardActionsStyle);
    }

    public CardActions(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
