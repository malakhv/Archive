...
public final class Shell {
     ...
     * Execute specified shell commands.
     * */
    public static ShellResult execute(String command, boolean root) {
     ...
     * Execute specified shell commands.
     * */
    public static ShellResult execute(String command, boolean root, boolean resultMsg) {
     ...
     * Execute specified shell commands.
     * */
    public static ShellResult execute(String[] commands, boolean root, boolean resultMsg) {
        try {
            return executeWithThrow(commands, root, resultMsg);
        } catch (Exception e) {
            return new ShellResult(EXEC_CMD_FAILED, null, e.getMessage());
        }
    }
     ...
     * Execute specified shell commands.
     */
    private static ShellResult executeWithThrow(String[] commands, boolean root, boolean resultMsg)
            throws Exception {
        int code = EXEC_CMD_FAILED;
        /* Проверка входных параметров */
        if (commands == null || commands.length == 0) {
            return new ShellResult(code, null, EXEC_FAILED_CMD_EMPTY_MSG);
        }
        ...
        return new ShellResult(code, successMsg, errorMsg);
    }
    ...
    public static class ShellResult {
        ...
        /**
         * Create {@link ShellResult} instance with specified values.
         * */
        public ShellResult(String cmd, int code) { this(cmd, code, null, null); }

        /**
         * Создает объект {@link ShellResult} с заданными
         * параметрами.
         *
         ...
         *
         * */
        public ShellResult(int code, String successMsg, String errorMsg) {
         ...
         * Create {@link ShellResult} instance with specified values.
         * */
        public ShellResult(String cmd, int code, String successMsg, String errorMsg) {
