...
function NetApiBufferAllocate(ByteCount: DWORD; Buffer: LPVOID): DWORD stdcall;

{$EXTERNALSYM NetApiBufferFree}
function NetApiBufferFree(Buffer: LPVOID): DWORD stdcall;
...
function NetApiBufferAllocate; external netapi name 'NetApiBufferAllocate';
function NetApiBufferFree;     external netapi name 'NetApiBufferFree';
