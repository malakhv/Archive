...
#pragma resource "*.dfm"
TdtPreview44 *dtPreview44;
//---------------------------------------------------------------------------
__fastcall TdtPreview44::TdtPreview44(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::q1Print(TObject *sender, AnsiString &Value)
{
 int    hPos=-1;
 int    i;
 AnsiString aVal="";
...
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::sband1BeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
        textColumn=0;
        textLines++;
...
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::smdAfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
  textLines=0;
  smr.t1Cnts=0;
...
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::FormCreate(TObject *Sender)
{
  textLines=1;
}
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::dtTotalPrint(TObject *sender,
      AnsiString &Value)
{
 int    hPos=-1;
 int    i;
...
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::sband1AfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
int i;
 i=textLines;
...
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::smbAfterPrint(TQRCustomBand *Sender,
      bool BandPrinted)
{
 textLines=1;
}
//---------------------------------------------------------------------------
void __fastcall TdtPreview44::smbBeforePrint(TQRCustomBand *Sender,
      bool &PrintBand)
{
  textColumn=0;
}
