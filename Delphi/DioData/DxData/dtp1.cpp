      ...
      bool &PrintBand)
{
  ...
  dtExpr->Caption=( smr.t1Cnts !=0 && smr.t2Cnts !=0 )?FloatToStrF(smr.t1 - smr.t2,ffFixed,5,2):AnsiString("???");
...
void __fastcall TdtPreview::qrInfPrint(TObject *sender, AnsiString &Value)
{
 //123
...
void __fastcall TdtPreview::FormCreate(TObject *Sender)
{
  Nakop = false;
}
//---------------------------------------------------------------------------
