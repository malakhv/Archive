 ...
 *
 */
public class InputService_arch extends InputMethodService implements KeyboardView.OnKeyboardActionListener {

    /** View клавиатуры. */
    private NemoKeyboardView mKeyboardView = null;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
            mKeyboardView.nextCol();
            mKeyboardView.updateColRowCount();
            return true;
        }

        /* Навигация в Лево */
        if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) { mKeyboardView.prevCol(); return true; }

        /* Навигация в Верх */
        if (keyCode == KeyEvent.KEYCODE_DPAD_UP) { mKeyboardView.prevRow(); return true; }

        /* Навигация в Низ */
        if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN) { mKeyboardView.nextRow(); return true; }
