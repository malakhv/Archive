...
import keyboard.nemo.box.NavKeyboardView;

/**
 * Created by malakhv on 21.11.14.
 */
public class NemoKeyboard extends NavKeyboardView {
     ...
     */
    public NemoKeyboard(Context context, AttributeSet attrs) { super(context, attrs); }

    /**
     * Создаёт новый объект {@code BasicKeyboardView} с заданными параметрами.
     */
    public NemoKeyboard(Context context, AttributeSet attrs, int defStyle) {
