...
public class ShellUtils {
    ...
    /** Символ конца строки команды */
    private static final String CMD_LINE_END = "\n";

    /**
     * Код результата выполнения команды:<br/>
     * Пустая команда.
     * */
    public static final int EXEC_CMD_FAILED = -1;

    /**
     * Сообщение об ошибке при выполнении команды:<br/>
     * Пустая команда.
     * */
     ...
     *
     * @return Объект {@link tv.nemo.box.updater.utils.ShellUtils.CmdResult}, который содержит информацию о результате выполнения команд.
     */
    ...
    public static class CmdResult {
        ...
        /**
         * Создает объект {@link CmdResult} с заданными
         * параметрами.
         *
