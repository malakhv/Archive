package com.vectordigital.commonlibs.network;
...
public interface Network {
     ...
     * @throws com.vectordigital.commonlibs.exceptions.NetworkException if server return status different from OK and NOT_MODIFIED or IO error occurred
     */
